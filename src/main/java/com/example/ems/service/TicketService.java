...
public class TicketService {
    ...
    public TicketDto createTicket(TicketDto ticketDto) {
        ...
        Timing selectTiming = eventService.getTimingForEvent(event.getId(), ticketDto.getTimingId());
    ...
    public List<TicketResponseDto> getTicketDetailsById() {
        ...
        return tickets.stream()
                .map(
                        ticket -> {
                            Timing selectedTiming = eventService.getTimingForEvent(ticket.getEvent().getId(),
                                    ticket.getTimingId());
